    	...
    	<div class="col-md-12">
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail" >
					...
					<img src="<c:url value="/resource/m3.jpg"/>" class="img-responsive">
					<div class="caption">
						<div class="row">
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail" >
					...
					<img src="<c:url value="/resource/m2.jpg"/>" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<h3>iPhone 6</h3>
            ...
            <div class="col-sm-6 col-md-4">
				<div class="thumbnail" >
					...
					<img src="<c:url value="/resource/m1.jpg"/>" class="img-responsive">
					<div class="caption">
						<div class="row">
							<div class="col-md-6 col-xs-6">
								<h3>Lumia 1520</h3>
